<template>
  ...
  <div class="content-box filter-box">
    ...
    <div class="d-flex mt-2 flex-wrap">
      ...
      <button class="confirm-btn btn btn-height me-2" @click="search">
        搜尋
      </button>
...
const handleFileUpload = async () => {
  ...
  const href =
    "http://ec2-34-221-251-1.us-west-2.compute.amazonaws.com:8080/leave";
  const headers = {
...
const search = async (group, month) => {
  let href =
    "http://ec2-34-221-251-1.us-west-2.compute.amazonaws.com:8080/curriculum";
  try {
